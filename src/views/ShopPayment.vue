    ...
    <div class="container">
      ...
      <div class="contents">
        ...
        <div class="payment-info-wrap">
            ...
            <div class="select">
              ...
              <div class="select-item">
                <input
                  ...
                  value="realtime"
                  v-model="paymentMethod"
                /><label for="real-time">실시간 계좌이체</label>
              </div>
              <div class="select-item">
                <input
                  type="radio"
          ...
          <button
            class="payment-check-allowed"
            v-if="agreeCheck.length === 2"
            @click="paymentPrecedure"
          >
            결제하기
          </button>
        </div>
...
export default {
  ...
  methods: {
    ...
    checkAgree() {
      if (this.agreeCheck.indexOf(1) !== -1) this.agreeCheck = [1, 2];
    },
    paymentPrecedure() {
      if (
        !this.recipient ||
        ...
        this.$store.state.paymentTotalPrice =
          this.productPrice + this.$store.state.deliPrice;
        this.modalActive = true;
