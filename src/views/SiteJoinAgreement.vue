<template>
  <div class="container">
      ...
      <div class="usage">제1조 목적<br><br>

본 이용약관은 “SF DROPSHIP”(이하 "사이트")의 서비스의 이용조건과 운영에 관한 제반사항 규정을 목적으로 합니다.<br><br>
...
2. 수집하는 개인정보 항목 : 이름, 로그인ID , 비밀번호 , 주소, 휴대전화번호 , 이메일 , 14세미만 가입자의 경우 법정대리인의 정보<br><br>
...
o 부정거래 방지 및 운영방침에 따른 보관 : 5년<br><br>
