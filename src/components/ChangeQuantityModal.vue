...
export default {
  ...
  methods: {
    ...
    async applyQuantity() {
      ...
      this.$store.state.profileShopList[
        this.idx
      ].productQuantity = this.quantity;
      this.$store.state.profileShopList[this.idx].totalProductPrice =
        this.quantity *
        this.$store.state.profileShopList[this.idx].productOriginalPrice;
